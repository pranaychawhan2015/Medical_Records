...
const ca1 = new FabricCAServices(caInfo.url, { trustedRoots: caTLSCACerts,
...
const ca3 = new FabricCAServices(caInfo3.url, { trustedRoots: caInfo3.
tlsCACerts.pem, verify: false }, caInfo3.caName);
...
const ca4 = new FabricCAServices(caInfo4.url, { trustedRoots: caInfo4.
tlsCACerts.pem, verify: false }, caInfo4.caName);
...
await transaction.submit('Patient102', 'Manees', 52, 'Pranay', 'Diabetes');
